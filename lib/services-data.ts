...
export const servicesData = [
    {
        ...
        icon: Server,
        logoImage: '',
        bannerImage: '/images/digital-infra-neon-bg.jpg',
        bgColor: '#2E3A59',
    ...
    },
    {
        ...
        icon: Shield,
        logoImage: '',
        bannerImage: '/images/integrated-security-surveillance-bg.jpg',
        bgColor: '#22C55E',
    ...
    },
    {
        ...
        icon: Code,
        logoImage: '',
        bannerImage: '/images/enterprise-apps-new-bg.jpg',
        bgColor: '#3B82F6',
    ...
    },
    {
        ...
        icon: Cloud,
        logoImage: '',
        bannerImage: '/images/cloud-virtualization-tech-bg.jpg',
        bgColor: '#38BDF8',
    ...
    },
    {
        ...
        bgColor: '#0F172A',
        title: 'Engineering & Electrical Services',
