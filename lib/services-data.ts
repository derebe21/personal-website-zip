...
export const servicesData = [
    {
        ...
        description: 'Digital infrastructure forms the backbone of modern technological advancements.',
        longDescription: 'Digital infrastructure forms the backbone of modern technological advancements. It encompasses the essential physical and virtual components that support information...',
    ...
    },
    {
        ...
        icon: Code,
        logoImage: '',
        bannerImage: '/images/enterprise-applications-cinematic.png',
        bgColor: '#3B82F6',
