...
export const metadata: Metadata = {
  ...
  description:
    'ITSEC Technology delivers end-to-end cybersecurity, digital infrastructure, unified communications, data center, and integrated security solutions in Addis Ababa, Ethiopia.',
  keywords: [
    'ITSEC Technology',
    'cybersecurity Ethiopia',
    'IT solutions Addis Ababa',
    'network security',
